...
import sizebay.catalog.client.auth.ApiKeyAuth;
import sizebay.catalog.client.auth.Authentication;
import sizebay.catalog.client.auth.HttpBasicAuth;
import sizebay.catalog.client.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://catalog.sizebay.com/api/v1";
  ...
  public ApiClient() {
    ...
    authentications.put("ApplicationKey", new ApiKeyAuth("header", "Application-Key"));
    authentications.put("SecurityKey", new ApiKeyAuth("header", "Security-Key"));
